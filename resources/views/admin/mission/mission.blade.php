...
<div class="row my-1">
	<div class="col text-right ">
		<a href="{{ route('add.mission') }}" class="btn btn-info "><i class="fa fa-plus"></i> Add New </a>
	</div>
</div>
<div class="row">
	<div class="col-sm-12">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<div>
										<img src="{{url('/')}}/public/mission/{{ $row->image}}" width="200" height="200">
									</div>
								</td>
								...
								<td class="text-left">
									<div class="actions">
										<a href="{{ route('add.mission', $row->id) }}" class="btn btn-sm bg-success-light"    >
											<i class="fe fe-pencil"></i> Edit
										</a>
										<form action="{{ route('delete.mission') }}" method="post" onsubmit="return confirm('Are You sure want to delete')" >@csrf
