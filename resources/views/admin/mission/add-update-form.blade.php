...
<div class="row">
	...
	<div class="card">
		<div class="card-header">
			<div class="h5">Update Mission</div>
		</div>
	<div class="card-body">
		<form action="{{route('add.update.mission')}}" method="post" enctype="multipart/form-data">@csrf 
				...
				<div class="col">
					...
					<div class="form-group">
						...
						<div class="my-3">
							...
							<img  alt="No image found upload one" src="{{ url('/') }}/public/mission/{{$data->image}}" width="400" height="400" class="img img-thumbnail">
                            <img id="image-preview" class="img img-thumbnail" src="{{ url('/') }}/public/mission/{{$data->image}}"  alt="Image Preview" style="display: none;" width="150" height="150"> <!-- Initially hidden -->
                        </div>
					</div>
