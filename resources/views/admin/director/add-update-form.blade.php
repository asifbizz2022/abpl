...
<div class="row">
	...
	<div class="card">
		<div class="card-header">
			<div class="h5">Update director</div>
		</div>
	<div class="card-body">
		<form action="{{route('add.update.director')}}" method="post" enctype="multipart/form-data">@csrf 
			...
			<div class="row">
				<div class="col">
					...
					<div class="form-group">
						...
						<div class="my-3">
							...
							<img  alt="No image found upload one" src="{{ url('/') }}/public/director/{{$data->image}}" width="400" height="400" class="img img-thumbnail">
                            <img id="image-preview" class="img img-thumbnail" src="{{ url('/') }}/public/director/{{$data->image}}"  alt="Image Preview" style="display: none;" width="150" height="150"> <!-- Initially hidden -->
                        </div>
					</div>
				...
				<div class="col"> 
					<div class="row">
						<div class="col">
							<label>Twitter</label>
							<input type="" class="form-control" value="{{$data->twitter}}" name="twitter">
						</div>
					 
						<div class="col">
							<label>Facebook</label>
							<input type="" class="form-control" value="{{$data->facebook}}" name="facebook">
						</div>
					 
						<div class="col">
							<label>Linked In</label>
							<input type="" class="form-control" value="{{$data->linkedin}}" name="linkedin">
						</div>
					</div>
			...
			<div class="row">
				...
				<div class="col"> 
					<div class="row">
						<div class="col">
							<label>Twitter</label>
							<input type="" class="form-control" value="{{ old('twitter')}}" name="twitter">
							@error('twitter')
							<small class="text-danger">
								{{$message}}
							</small> 
						...
						<div class="col">
							<label>Facebook</label>
							<input type="" class="form-control" value="{{ old('facebook')}}" name="facebook">
							@error('facebook')
							<small class="text-danger">
								{{$message}}
							</small> 
						...
						<div class="col">
							<label>Linked In</label>
							<input type="" class="form-control" value="{{ old('linkedin')}}" name="linkedin">
							@error('linkedin')
							<small class="text-danger">
								{{$message}}
							</small> 
